...
ROLE_DEFINITIONS: tuple[dict[str, str], ...] = (
    {
        ...
        "role_description": "Analyze approved game requirements, stable feature and delivery-slice IDs, ambiguities, and traceability when preparing project or slice inputs.",
        "role_inputs": "- Approved GDD/Roadmap fragments\n- Stable feature, slice, or system IDs\n- Existing traceability graph",
        "role_outputs": "- Requirement and slice-boundary findings\n- Proposed traceability nodes/edges\n- Blocking source questions",
    ...
    },
    {
        ...
        "role_description": "Maintain full-project architecture coverage and assess affected modules when a delivery slice or bootstrap phase requires boundaries, contracts, risks, or ADR-ready evidence.",
    ...
    },
    {
        ...
        "role_short_description": "Turn one feature slice into a bounded vertical implementation plan.",
        "role_description": "Plan exactly one eligible playable or explicitly justified enabling slice after its requirements and full affected-module constraints are known.",
        "role_inputs": "- One stable feature ID and child slice ID\n- Architecture model, module catalog, and slice backlog refs\n- Current project state",
        "role_outputs": "- End-to-end scenario and touched-module path\n- Ordered implementation tasks and architecture delta\n- Mandatory smoke, verification, and rollback criteria",
        "role_success": "The plan is vertically complete, dependency-aware, ownership-safe, and has a non-waivable canonical smoke.",
        "sandbox_mode": "read-only",
        "write_boundary": "Do not modify project files.",
    },
    {
        ...
        "role_short_description": "Implement one approved delivery slice inside its worktree.",
        "role_description": "Implement exactly one approved delivery slice from an accepted plan inside the assigned feature worktree.",
        "role_inputs": "- Accepted slice plan\n- Assigned feature worktree and write set\n- Canonical commands",
    ...
    },
    {
        ...
        "role_description": "Review an implemented delivery slice for correctness, full affected-module architecture compliance, regressions, and missing evidence before acceptance.",
        "role_inputs": "- Slice plan, mandatory smoke, and diff\n- Architecture/NFR refs\n- Implementation evidence",
    ...
    },
    {
        ...
        "role_description": "Execute the mandatory slice smoke and evaluate optional coverage against approved acceptance criteria, NFRs, and declared target platforms.",
        "role_inputs": "- Slice acceptance scenario\n- Smoke/test plan and canonical commands\n- Build/runtime evidence",
    ...
    },
    {
        ...
        "role_description": "Verify that one delivery slice is end-to-end complete with independent smoke, architecture, engineering, traceability, and gate evidence before acceptance.",
        "role_inputs": "- Slice plan, review, mandatory smoke, and optional coverage results\n- Architecture records and traceability graph\n- Gate and approval records",
