...
2. Read [references/engineering-rules.md](references/engineering-rules.md) before writing or reviewing Unreal Engine game code. Enforce only its approved rules; do not add or amend a rule without separate explicit human approval.
